...
public class Claims implements Serializable {
	...
	public String toString() {
		return "Claims [Claims_Id=" + Claims_Id + ", Claims_Description=" + Claims_Description + ", Claims_Date="
				+ Claims_Date + ", Claims_image=" + Claims_image + ", Claims_Type=" + Claims_Type + "]";
	}
	public Claims(Long claims_Id, String claims_Description, Date claims_Date, String claims_image,
			String claims_Type) {
		super();
		Claims_Id = claims_Id;
		Claims_Description = claims_Description;
